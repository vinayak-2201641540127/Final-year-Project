...
const NavBar = () => {
  return (
    <div className="h-15 flex items-center justify-between navbar ">
      ...
      <div className="right flex items-center justify-center w-fit gap-3 mr-7">
        <button className="flex justify-center items-center text-xl hover:cursor-pointer gap-1 mr-3 bg-orange-600 text-white p-2 rounded-full">
